...
*** DE (Wayland)
#+BEGIN_SRC sh
pacman -S xorg-server-xwayland sway waybar bemenu mako grim slurp wl-
#+END_SRC

*** DE (Xorg)
#+BEGIN_SRC sh
pacman -S xorg-server xorg-xinit xorg-xrdb xorg-xrandr xf86-video-amdgpu i3-gaps rofi dunst xclip scrot feh
#+END_SRC
